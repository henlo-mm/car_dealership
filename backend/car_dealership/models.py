...
class WorkOrder(models.Model):
    ...
    customer_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='customer_work_orders')
    workshop_manager_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='workshop_manager_work_orders')
    description = models.CharField(max_length=255, null=False)
    comments = models.TextField(null=True)
    start_date = models.DateTimeField(null=False)
    status_id = models.ForeignKey(WorkOrderStatus, on_delete=models.CASCADE)
